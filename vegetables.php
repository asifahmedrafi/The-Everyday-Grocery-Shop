			...
			<div class="w3l_banner_nav_right_banner3_btm">
				<div class="col-md-4 w3l_banner_nav_right_banner3_btml">
					<div class="view view-tenth">
						...
						<div class="mask">
							<h4>The Everyday Grocery Shop</h4>
							<p></p>
						</div>
					</div>
					<h4> Vegetables</h4>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="item_name" value="Oinion" />
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4><i class="৳"> 60.00 </i><span><i class="৳"><del> 80.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4><i class="৳"> 20.00 </i><span><i class="৳"><del> 30.00</del> </i></span></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<h4><i class="৳"> 10.00 </i><span><i class="৳"><del> 15.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>poteto(1kg)</p>
											<h4><i class="৳"> 30.00 </i><span><i class="৳"><del> 40.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="poteto" />
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Hari Mirch" />
													<input type="hidden" name="amount" value="30.00" />
													<input type="hidden" name="discount_amount" value="1.00" />
													<input type="hidden" name="currency_code" value="BDT" />
													<input type="hidden" name="return" value=" " />
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p>Tamatar(1 kg)</p>
											<h4><i class="৳"> 80.00 </i><span><i class="৳"><del> 100.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Tamater" />
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											...
											<p> Peas(1 kg)</p>
											<h4><i class="৳"> 60.00 </i><span><i class="৳"><del> 70.00</del> </i></h4>
										</div>
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Spring Oinion" />
													<input type="hidden" name="amount" value="20.00" />
													<input type="hidden" name="discount_amount" value="1.00" />
													<input type="hidden" name="currency_code" value="BDT" />
													<input type="hidden" name="return" value=" " />
										...
										<div class="snipcart-details">
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="add" value="1" />
													<input type="hidden" name="business" value=" " />
													<input type="hidden" name="item_name" value="Simala Mirchi" />
													<input type="hidden" name="amount" value="20.00" />
													<input type="hidden" name="discount_amount" value="1.00" />
													<input type="hidden" name="currency_code" value="BDT" />
													<input type="hidden" name="return" value=" " />
