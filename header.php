    ...
    <meta name="keywords" content="The Everyday Grocery Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design">
...
<body>
    ...
    <div class="agileits_header">
      <div class="w3l_offers"> <a href="#">The Everyday Grocery Shop</a> </div>
    ...
    <div class="logo_products">
      <div class="container">
        <div class="w3ls_logo_products_left">
          <h1><a href="index.php"><span>The Everyday Grocery</span> Shop</a></h1>
        </div>
        ...
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:01534982412">(+880) 01534982412</a></li>
            <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:shop@everydaygrocery.com"> <a href="mailto:shop@everydaygrocery.com">shop@everydaygrocery.com</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
