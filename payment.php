...
<html>
<head>
<title>The Everyday Grocery Shop a Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Payment :: Asif Ahmed Rafi</title>
                                     ...
                                     <div class="vertical_post">
									  <form action="#" method="post">
										...
										<div class="swit-radio">								
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio" checked=""><i></i>AB Bank</label> </div></div>
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i> Brac Bank</label> </div></div>
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>CIty Bank</label> </div></div>	
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>Rupali Bank</label> </div></div>	
											<div class="check_box_one"> <div class="radio_one"> <label><input type="radio" name="radio"><i></i>Janata Bank</label> </div></div>		
                ...
                <div>
                    <div id="tab4" class="tab-grid" style="display: block;">
                        ...
                        <div class="col-md-6">
                            ...
                            <p>Important: You will be redirected to Bkash's website to securely complete your payment.</p><a class="btn btn-primary">Checkout via Bkash</a>	
                        </div>
                        <div class="col-md-6">
                            <form class="cc-form">
                                <div class="clearfix">
